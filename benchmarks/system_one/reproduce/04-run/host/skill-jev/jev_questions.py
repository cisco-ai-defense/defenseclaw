...
SHIM = os.environ.get("SHIM", "http://127.0.0.1:8311/v1/systemone")
MODEL = os.environ.get("JEV_MODEL", "qwen")
...
def ask(state, questions, timeout=180):
    ...
    req = urllib.request.Request(SHIM, data=body, headers={"Content-Type": "application/json"}, method="POST")
    try:
