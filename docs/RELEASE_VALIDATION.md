...
macOS signing credentials are optional as one complete group. All five
Developer ID and notary values produce signed, notarized artifacts with the
normal names. If all five are absent, the same release continues with
