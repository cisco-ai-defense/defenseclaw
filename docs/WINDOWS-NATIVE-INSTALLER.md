...
Version `0.8.7` was the first published native Windows Setup, so its release
acceptance was fresh-install-only. The immutable `0.8.6` release has no native
Setup or Windows runtime assets. Published releases `0.8.7` through `0.8.10`
