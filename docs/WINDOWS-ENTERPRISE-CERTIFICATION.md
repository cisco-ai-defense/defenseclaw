...
| --- | --- |
| Enterprise opt-in | A build containing enterprise support makes no machine-level change until the administrator runs `packaging/windows/install-enterprise.ps1` with `deployment_mode: managed_enterprise`. |
