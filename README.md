...
| [Native Windows](docs/WINDOWS-NATIVE-INSTALLER.md) | PowerShell install, native connectors, verification, and troubleshooting |
...
the [Native Windows guide](docs/WINDOWS-NATIVE-INSTALLER.md).
