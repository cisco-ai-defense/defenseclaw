...
ACTION_AGENT_CONTROL_SYNC: Final[str] = "agent-control-sync"
ACTION_AGENT_CONTROL_PUBLISH: Final[str] = "agent-control-publish"
ACTION_AGENT_CONTROL_ACTIVATE: Final[str] = "agent-control-activate"
ACTION_AGENT_CONTROL_ROLLBACK: Final[str] = "agent-control-rollback"
