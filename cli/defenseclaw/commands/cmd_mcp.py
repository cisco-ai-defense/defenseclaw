...
def set_server(
    ...
    if scan_required:
        ...
        # publishers can hide dangerous behavior behind an env
        # gate. We propagate entry["env"] (if any) into the scan
        # entry so install-time scanning sees what runtime sees.
