...
const file_secureclient_proto_rawDesc = "" +
	...
	"\x1aSERVICE_AVAILABILITY_READY\x10\x02\x12!\n" +
	...
	"\x18STATS_AVAILABILITY_STALE\x10\x02\x12\"\n" +
	"\x1eSTATS_AVAILABILITY_UNAVAILABLE\x10\x03\x12\x1c\n" +
	"\x18STATS_AVAILABILITY_ERROR\x10\x04*\xa1\x01\n" +
	...
	"\x1bNOTIFICATION_SEVERITY_ERROR\x10\x03*\xca\x01\n" +
	"\x18NotificationPresentation\x12)\n" +
	"%NOTIFICATION_PRESENTATION_UNSPECIFIED\x10\x00\x12'\n" +
	"#NOTIFICATION_PRESENTATION_TRANSIENT\x10\x01\x12%\n" +
	"!NOTIFICATION_PRESENTATION_HISTORY\x10\x02\x123\n" +
	"/NOTIFICATION_PRESENTATION_TRANSIENT_AND_HISTORY\x10\x032\x84\x03\n" +
	"\x1eDefenseClawSecureClientService\x12i\n" +
	"\tGetHealth\x12-.defenseclaw.secureclient.v1.GetHealthRequest\x1a+.defenseclaw.secureclient.v1.HealthSnapshot0\x01\x12v\n" +
	"\x10GetStatsSnapshot\x124.defenseclaw.secureclient.v1.GetStatsSnapshotRequest\x1a*.defenseclaw.secureclient.v1.StatsSnapshot0\x01\x12\x7f\n" +
	"\x12WatchNotifications\x126.defenseclaw.secureclient.v1.WatchNotificationsRequest\x1a/.defenseclaw.secureclient.v1.NotificationRecord0\x01BTZRgithub.com/defenseclaw/defenseclaw/proto/defenseclaw/secureclient/v1;defenseclawv1b\x06proto3"
