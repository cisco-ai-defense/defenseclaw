---
title: Antigravity
description: Google Antigravity (`agy`) lifecycle hook contract and setup paths for macOS, Linux, and native Windows.
keywords:
...
publish CLI v1.1.10. The
[official install page](https://antigravity.google/docs/cli/install) documents
native Windows, macOS, and Linux clients. This is vendor availability metadata,
not DefenseClaw validation or certification.
...
[installation guide](https://antigravity.google/docs/cli/install), complete its
...
Setup writes five DefenseClaw-owned registrations to
