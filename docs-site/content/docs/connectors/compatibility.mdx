...
certified on native Windows. The Windows release currently certifies only
Codex and Claude Code; see the
...
validation points, not minimum versions. Antigravity is gated at `>=1.0.0`.
