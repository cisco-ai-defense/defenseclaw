...
| `DefenseClawHookEnumerator` | LocalSystem | Protected target manifest and allow-listed profile discovery | Refresh the declared connector inventory without granting the gateway broad profile traversal. |
