...
<Cards>
  ...
  <Card
    ...
    description="Distribute OPA posture and additive managed rules from self-hosted Agent Control or Cisco Cloud Control while DefenseClaw enforces locally."
  />
  <Card
