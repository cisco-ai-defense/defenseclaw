...
<Cards>
  ...
  />
  <Card
    title="Agent Control policy distribution"
    href="/docs/setup/agent-control"
    description="Choose local, Agent Control-managed, or hybrid regex authority and distribute OPA posture from self-hosted Agent Control or Cisco Cloud Control while DefenseClaw enforces locally."
  />
  <Card
