...
<Cards>
  ...
  <Card title="setup windsurf" href="/docs/setup/guardrail/aliases" description="Adds or reconfigures the Devin Desktop legacy Cascade-only preview. Devin Local/cloud/ACP are unsupported." />
