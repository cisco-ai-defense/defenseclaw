...
<Cards>
  ...
  />
  <Card
    title="Linux enterprise validation"
    href="/docs/setup/enterprise-hardening-validation"
    description="Run lab-safe root-boundary, hook tamper, symlink, mode, token-isolation, and watcher-stability tests."
  />
  <Card
