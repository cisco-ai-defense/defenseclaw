...
first_party_allow_list:
  - target_type: skill
    ...
    source_path_contains: [".openclaw/workspace/skills/codeguard", ".openclaw/skills/codeguard", ".zeptoclaw/skills/codeguard", ".claude/skills/codeguard", ".agents/skills/codeguard"]
```
