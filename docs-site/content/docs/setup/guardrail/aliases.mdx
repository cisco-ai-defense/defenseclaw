...
description: Connector-oriented setup aliases for supported DefenseClaw integrations.
keywords:
...
<Cards>
  ...
  <Card title="Devin" href="/docs/connectors/devin" description="defenseclaw setup devin" />
