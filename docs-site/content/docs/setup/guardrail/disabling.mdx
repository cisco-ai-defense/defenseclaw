...
| Gemini CLI (retired cleanup only) | `~/.gemini/settings.json` | Use `defenseclaw setup remove geminicli --yes` to remove receipt-bound DefenseClaw hook and telemetry entries. |
