...
The balanced/default enabled catalog currently contains 237 local rules across
seven families, including 133 CEL declarations and 120 tool-call-only rules.
