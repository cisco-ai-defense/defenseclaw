...
The balanced/default enabled catalog currently contains 185 local rules across
seven families, including 82 CEL declarations and 62 tool-call-only rules.
