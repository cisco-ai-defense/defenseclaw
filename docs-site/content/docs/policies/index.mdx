...
The balanced/default enabled catalog currently contains 184 local rules across
seven families, including 81 CEL declarations and 61 tool-call-only rules.
Exact ActionFacts validators, 18 bounded tool-call chains, five YARA
