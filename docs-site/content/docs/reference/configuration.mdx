...
file. See [Upgrade DefenseClaw](/docs/get-started/upgrade) for the backup,
...
| OmniGent | `~/.omnigent/config.yaml`, `~/.defenseclaw/hooks/defenseclaw_omnigent_policy.py`, and `defenseclaw_omnigent.pth` in OmniGent's Python environment |
