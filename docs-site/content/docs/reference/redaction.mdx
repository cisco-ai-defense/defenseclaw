...
`observability.redaction_profiles`, reproducing the v7 field-class mode vector
exactly -- metadata preserved, every other class whole-replaced. Because it is a
normal custom profile rather than an immutable built-in, you can read it, edit
it, or point destinations somewhere else.
