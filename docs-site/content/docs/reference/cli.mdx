...
support claim. Native Windows offers Claude Code, Codex, and the other labeled
implementations only as previews or not-certified choices, and some
...
| `defenseclaw setup geminicli` | Hook setup alias for the continuing enterprise/Google Cloud/paid API-key Gemini CLI product; defaults to observe, pass `--mode action` to block hook-side. Consumer/free/Google AI Pro/Ultra service ended June 18, 2026. |
