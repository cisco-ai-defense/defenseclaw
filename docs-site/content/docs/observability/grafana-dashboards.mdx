...
DefenseClaw provisions a focused catalog of 16 Grafana dashboards. Each board
...
<Cards>
  ...
  <Card title="Blocked Events & Analysis" href="http://localhost:3000/d/defenseclaw-blocked-events" description="Enforced and would-block decisions, exact rule IDs, post-redaction evidence, recurring signatures, and investigation pivots." />
...
| **Blocked Events & Analysis** (`defenseclaw-blocked-events`) | What was blocked, which rules drove it, and which events recur? | SOC, policy owner, incident responder | Prometheus, Loki | Enforced versus observe-mode decisions, all exported verdict rule IDs, projected tool context, exact recurring signatures, and correlation pivots into Agent360, Findings, and Policy Decisions. |
...
- **Retain the 16 boards above.** Each owns a distinct operator question or a
