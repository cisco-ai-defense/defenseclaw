...
| **Scanners (Ops)** (`defenseclaw-scanners`) | Are scanners keeping up and producing healthy results? | Detection engineer, SRE | Prometheus | Scanner throughput, duration, errors, and operational finding trends. |
...
![Agent360 directed topology and trace drill-down](/images/grafana/agent360-topology.jpg)
