...
<Callout type="warning">The bundled shell/Compose stack is supported on macOS and Linux and is unsupported on Windows. Windows operators can use supported remote OTLP, HEC, or webhook sinks instead.</Callout>
