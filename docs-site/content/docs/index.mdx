...
<Cards>
  <Card title="13 connectors" href="/docs/connectors" description="OpenClaw, ZeptoClaw, Claude Code, Codex, Cursor, Devin, GitHub Copilot CLI, OpenHands, Antigravity, Hermes, OpenCode, Amp, OmniGent." />
