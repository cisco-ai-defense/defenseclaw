...
<Cards>
  <Card title="12 connector surfaces" href="/docs/connectors" description="OpenClaw, ZeptoClaw, Claude Code, Codex, Hermes, Cursor, Windsurf, Gemini CLI, GitHub Copilot CLI, Microsoft Scout, OpenHands, Antigravity." />
