...
| --- | --- | --- | --- | --- |
| macOS | Endpoint Security via `eslogger` | root **and** Full Disk Access | exec with argv, exit, file read/write on watched paths | account creation and privilege events, which are recognised from argv instead |
