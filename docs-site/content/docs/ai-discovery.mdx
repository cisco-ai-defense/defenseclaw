...
Claude Code, Codex, Cursor, Devin Desktop legacy Cascade, Gemini CLI, GitHub Copilot CLI,
...
| --- | --- |
| `supported_connector` | OpenClaw, ZeptoClaw, Claude Code, Codex, Cursor, Devin Desktop legacy Cascade, Gemini CLI, GitHub Copilot CLI, OpenHands, Antigravity, Hermes, OpenCode, Amp, OmniGent |
...
| `desktop_app` | Claude Desktop, Cursor, Devin Desktop (formerly Windsurf) macOS / Windows app installs |
