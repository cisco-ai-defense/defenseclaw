...
Windows, choose a labeled preview such as Claude Code or Codex CLI
from the [Native Windows guide](/docs/get-started/windows). Other platforms also offer proxy and
