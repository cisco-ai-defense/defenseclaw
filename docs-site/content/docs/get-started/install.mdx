...
[`defenseclaw init`](/docs/get-started/quickstart) does that interactively. It
will not replace an existing installation—use
[`defenseclaw upgrade`](/docs/get-started/upgrade) instead.
