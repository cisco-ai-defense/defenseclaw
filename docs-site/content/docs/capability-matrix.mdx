...
Platform availability, setup, and operating-system-specific limits live in the
[connector platform table](/docs/connectors#platform-support) and on each
connector page. A supported native Windows path does not fabricate
official-client validation evidence, and the Windows package does not provide
the proxy or subprocess-sandbox topology used by some connectors elsewhere.
</Callout>
