...
// links generated by older builds round-trip cleanly. Without this,
// `policy.correlator.map(...)` and `policy.cisco_ai_defense.enabled`
// throw TypeError the moment the wizard renders the imported policy.
//
...
function normalizeImportedPolicy(parsed: Policy): Policy {
