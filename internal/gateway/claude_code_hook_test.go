...
func TestEvaluateClaudeCodeHook_OwnedMetadataEventsInspectEventContent(t *testing.T) {
	...
	tests := []claudeCodeHookRequest{
		{HookEventName: "SubagentStart", AgentType: trustExploitKeyword()},
		{HookEventName: "CwdChanged", NewCWD: trustExploitKeyword()},
		{HookEventName: "DirectoryAdded", Directory: trustExploitKeyword(), Source: "slash_command"},
		{HookEventName: "WorktreeRemove", WorktreePath: trustExploitKeyword()},
	}
