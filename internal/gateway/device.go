...
func LoadOrCreateIdentity(keyFile string) (*DeviceIdentity, error) {
	if data, err := os.ReadFile(keyFile); err == nil {
		// Avarice F-2551: ensure long-lived gateway installs that
	...
	// Avarice F-2551: write a sibling provenance sentinel so the
...
func writeDeviceKeyProvenance(keyFile, source string) {
	...
	payload := fmt.Sprintf(
		"# DefenseClaw device.key provenance sentinel (F-2551)\n"+
