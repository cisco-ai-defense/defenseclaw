...
func TestExtractHookPayloadReportedCost(t *testing.T) {
	...
	for _, tc := range []struct {
		...
		{"top-level", map[string]interface{}{"total_cost_usd": 1.25}, hookReportedCost{USD: 1.25, Present: true}},
		...
		{"reported zero is present", map[string]interface{}{"sessionCostUsd": 0}, hookReportedCost{USD: 0, Present: true}},
