...
func hookLifecycleV8EventInput(base observability.LogCompatSessionStartInput) observability.LogCompatEventInput {
	return observability.LogCompatEventInput{
		...
		UserID:                            base.UserID, DefenseClawUserIDKind: base.DefenseClawUserIDKind,
		DefenseClawUserName: base.DefenseClawUserName, DefenseClawUserEmail: base.DefenseClawUserEmail,
