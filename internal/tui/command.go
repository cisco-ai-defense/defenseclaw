...
func BuildRegistry() []CmdEntry {
	...
	return []CmdEntry{
		...
		{TUIName: "setup codex", CLIBinary: dc, CLIArgs: []string{"setup", "codex"}, Description: "Install DefenseClaw Codex hooks", Category: "setup"},
		{TUIName: "setup codex --status", CLIBinary: dc, CLIArgs: []string{"setup", "codex", "--status"}, Description: "Show Codex hook integration status", Category: "setup"},
		{TUIName: "setup codex --scan-components", CLIBinary: dc, CLIArgs: []string{"setup", "codex", "--scan-components", "--non-interactive"}, Description: "Scan Codex skills/plugins/MCP config", Category: "setup"},
		{TUIName: "setup claude-code", CLIBinary: dc, CLIArgs: []string{"setup", "claude-code"}, Description: "Install DefenseClaw Claude Code hooks", Category: "setup"},
		{TUIName: "setup claude-code --status", CLIBinary: dc, CLIArgs: []string{"setup", "claude-code", "--status"}, Description: "Show Claude Code hook integration status", Category: "setup"},
		{TUIName: "setup claude-code --scan-components", CLIBinary: dc, CLIArgs: []string{"setup", "claude-code", "--scan-components", "--non-interactive"}, Description: "Scan Claude Code skills/plugins/MCP config", Category: "setup"},
