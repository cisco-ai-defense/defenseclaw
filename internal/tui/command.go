...
func BuildRegistry() []CmdEntry {
	...
	return []CmdEntry{
		...
		{TUIName: "keys fill-missing", CLIBinary: dc, CLIArgs: []string{"keys", "fill-missing", "--yes"}, Description: "List missing required credentials", Category: "setup"},
		...
		{TUIName: "fix credentials", CLIBinary: dc, CLIArgs: []string{"keys", "fill-missing", "--yes"}, Description: "List missing required credentials", Category: "setup"},
