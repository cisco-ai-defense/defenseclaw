...
func BuildRegistry() []CmdEntry {
	...
	return []CmdEntry{
		...
		{TUIName: "setup openhands", CLIBinary: dc, CLIArgs: []string{"setup", "openhands", "--yes"}, Description: "Configure OpenHands observability hooks", Category: "setup"},
		{TUIName: "setup mode", CLIBinary: dc, CLIArgs: []string{"setup", "mode"}, Description: "Fast/scripted connector switch", Category: "setup", NeedsArg: true, ArgHint: "<openclaw|codex|claudecode|zeptoclaw|hermes|cursor|windsurf|geminicli|copilot|openhands>"},
		...
		{TUIName: "keys fill-missing", CLIBinary: dc, CLIArgs: []string{"keys", "fill-missing", "--non-interactive"}, Description: "List missing required credentials", Category: "setup"},
		...
		{TUIName: "fix credentials", CLIBinary: dc, CLIArgs: []string{"keys", "fill-missing", "--non-interactive"}, Description: "List missing required credentials", Category: "setup"},
