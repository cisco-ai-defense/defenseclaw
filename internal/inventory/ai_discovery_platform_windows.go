...
// Matches the coarse gate the enterprise-hook enumerator uses (S-1-5-21-...
// with 5+ sub-authorities, plus S-1-12-1-... for Entra); virtual service
// accounts (S-1-5-80-...), well-known principals (S-1-5-18 LocalSystem,
// S-1-5-19/20), and machine SIDs never
