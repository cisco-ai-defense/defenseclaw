...
func LoadFromBytes(configFile string, raw []byte) (*Config, error) {
	return loadConfigSource(configFile, false, append([]byte(nil), raw...), true, true, false)
}
...
func LoadCandidateFromBytes(configFile string, raw []byte) (*Config, error) {
	return loadConfigSource(configFile, false, append([]byte(nil), raw...), true, false, false)
}
...
func LoadRuntimeV8FromBytes(configFile string, raw []byte) (*Config, error) {
	...
	candidate, err := loadConfigSource(configFile, false, append([]byte(nil), raw...), true, true, true)
	if err != nil {
		return nil, err
	}
...
func LoadRuntimeV8CandidateFromBytes(configFile string, raw []byte) (*Config, error) {
	...
	candidate, err := loadConfigSource(configFile, false, append([]byte(nil), raw...), true, false, true)
	if err != nil {
		return nil, err
	}
	applyRuntimeV8DataDirDefaults(candidate, document, candidate.DataDir)
...
func loadFromFile(configFile string, migrateRuntime bool) (*Config, error) {
	return loadConfigSource(configFile, migrateRuntime, nil, false, true, false)
}
