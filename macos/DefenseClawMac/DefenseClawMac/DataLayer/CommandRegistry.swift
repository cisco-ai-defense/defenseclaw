...
enum CommandRegistry {
    ...
    static let all: [CommandDefinition] = [
        ...
        CommandDefinition(id: 157, title: "upgrade", binary: "defenseclaw", arguments: ["upgrade", "--yes"], summary: "Update to the latest release by downloading and running its install.sh", category: "other", requiresInput: false, usage: ""),
